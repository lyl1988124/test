...
//                Gson g = new Gson();
//                Object clone = gson.fromJson(g.toJson(javaBean, javaBean.getClass()), javaBean.getClass());
                //JsonUtils.objectToJson(javaBean);

                Object clone = BeanUtils.cloneBean(javaBean);
